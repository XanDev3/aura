 ...
 * charge based on actual usage. This estimator runs pre-inference and uses a 2x margin
 * to cover output token estimation uncertainty.
 *
...
// 2x margin: covers uncertainty in output token estimation
const MARGIN_MULTIPLIER = 2.0;

/** Minimum charge — floor to avoid dust amounts */
